...
export default class App extends React.Component {
  ...
  render() { return(<div>
    <h1>{this.state.ready ? this.state.greenLine.name : ""} ||| Total Sales: {this.state.ready ? this.state.greenLine.totalPax: ""}</h1>
    {this.state.ready ? this.state.greenLine.blocks.map((b)=><ReactBlock Block = {b} color = 'success' />) : ""}
    <h1>{this.state.ready ? this.state.redLine.name : ""} ||| Total Sales: {this.state.ready ? this.state.greenLine.totalPax: ""}</h1>
