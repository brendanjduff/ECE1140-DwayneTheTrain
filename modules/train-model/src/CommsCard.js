    ...
    return (
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            <strong>SpeedCmd: </strong>{msToMph(this.props.train.thru.speedCmd).toFixed(1)} mph<br />
            <strong>AuthorityCmd: </strong>{this.props.train.thru.authorityCmd} blocks<br />
            <strong>PowerCmd: </strong>{parseFloat(this.props.train.state.powerCmd/1000).toFixed(0)} kW<br />
